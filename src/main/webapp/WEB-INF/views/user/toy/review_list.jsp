...
<c:forEach var="item" items="${reviewBookVos}">
	<div style="width: 500px; margin: 50px auto">
		<form class="modifyForm" name="modify_form"
			style="border: 1px solid #000; padding: 5px 10px; border-radius: 5px">
			...
			<p>
				<input disabled style="width: 100%; border: none;" type="text" value="${item.u_m_id}" />
			</p>
			<p>
				<textarea disabled style="width: 100%; height: auto; padding: 5px; border: none; resize: none;"
						  name="rev_content" placeholder="댓글을 등록해 주세요.">${item.rev_content}
				</textarea>
			</p>
			<c:if test="${item.u_m_no == loginedUserMemberVo.u_m_no}">
			<div>
