...
<body>
	...
	<section>
		...
		<div id="section_wrap">
			...
			<div
				style="width: 500px; margin: 50px auto; display: flex; justify-content: center;">
				<div style="margin: 0 10px; font-size: 20px">
					<span style="cursor: pointer" onclick="likeBtn(this)"> 
						<i class="fa-solid fa-heart"></i>
					</span> 
					<span id="likecnt">${bookVo.like_b_no_count}</span>
				</div>
				<div style="margin: 0 10px; font-size: 20px">
					<span>
			...
			%>	
				<div style="width:500px; margin:50px auto">
					<form name="add_form" style="border:1px solid #000; padding:5px 10px; border-radius:5px">
						...
						<p>
							<input disabled style="width:100%; border:none;" type="text" value="${loginedUserMemberVo.u_m_id}"/>
						</p>
						<p>
							<textarea style="width:100%; height:80px; padding:5px; border:none; resize:none;" name="rev_content" placeholder="댓글을 등록해 주세요."></textarea>
						</p>
						<p style="text-align:right;">
							<input style="padding:0 5px;" type="button" value="등록" onclick="reviewWrite()" />
						</p>
	...
	<script>
		...
		function reviewWrite(){
			...
			let rev_content = form.rev_content.value; //jQ('form input[name=rev_content]').val()
